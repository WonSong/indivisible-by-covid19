...
export function Panel(): React.ReactElement {
    return (
        <Styled.Root>
            <Styled.Section>
                <Styled.Heading>About this site</Styled.Heading>
                <Styled.Text>
                    This site was created to raise awareness about rapidly increasing hate crimes against Asian
                    Americans.
                </Styled.Text>
                <Styled.Text>
                    The data shown on this site was collected by searching the web. If you are aware of more incidents
                    that are not mentioned in the site, please let me know by sending links to a news article or social
                    media posts at <a>hello+covid@wonsong.me</a>.
                </Styled.Text>
            </Styled.Section>
            ...
            <Styled.Section>
                ...
                <Styled.Text>
                    While this site wasn't created for profit, it still takes lots of time to develop, maintain and
                    gather data. <br />
                    Please support this site by buying me a coffee!
                </Styled.Text>
                <div
